...
| `* * *`  | new user          | add hairType type of customer                                                                | choose the correct products when treating their hairType                             |
| `* * *`  | new user          | add skinType type of customer                                                                | choose the appropriate products when treating their skinType                         |
