...
| `* * *`  | Teaching Assistant                                        | delete a task given to a student                                                       | delete the task from the list of tasks                                                        |
...
| `* *`    | Teaching Assistant                                        | delete multiple students from TAPA after the module is over                            | remove students that are no longer being taught, after the semester is over                   |
