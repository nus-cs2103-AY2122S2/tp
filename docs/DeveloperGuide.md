...
| `* *`    | Teaching Assistant                                        | delete multiple tasks assigned to students                                             | remove any tasks that has incorrect information without having to individually delete them    |
