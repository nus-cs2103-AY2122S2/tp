...
2.  HireLah shows a list of persons
3.  User requests to delete a specific person in the list
4.  HireLah deletes the person
...
1.  User requests to list persons
2.  HireLah shows a list of persons
3.  User requests to add a specific interview to a person in the list
4.  HireLah adds the interview to the person.
