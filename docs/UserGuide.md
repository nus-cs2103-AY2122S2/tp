...
`find n:Water` lists all products that contains Water as name.

`find n:Bread c:Food` lists all products that has contains Bread as name and Food as category.
