...
Format: `update L/LINEUP n/NEW_LINEUP_NAME`

* Update the lineup name of lineup LINEUP to NEW_LINEUP_NAME

Example:
* `update L/Starting5 n/Worst5` will change lineup Starting5 to lineup Worst5
