...
| COMMENT   | c/     | A comment can only contain **ASCII values** and is limited to 300000 **ASCII values**.                                                                                                                                                                                                                                                                                                                      |
...
| **ASCII**                   | A 8-bit character set containing 128 characters. This includes number 0-9, upper and lower case english Letters (A-Z) and certain special characters.                |
