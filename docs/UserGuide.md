...
**Delete** | **Any View** <br> `delete o/module m/[MODULECODE]`[(example)](#delete-module-by-module-code)<br> `delete o/group m/[MODULECODE] g/[GROUPNAME]`[(example)](#delete-group-by-module-code-and-group-name)<br><br> **People View:** <br> `delete [INDEX]`[(example)](#delete-a-person-by-index) <br>`delete [INDEX] p/ e/ t/[TAG] of/`[(example)](#delete-a-person's-information) <br><br> **Modules View:**<br>`delete [INDEX]`[(example)](#delete-a-module-by-Index) <br>`delete [INDEX] stu/[INDEX]`[(example)](#remove-a-student-from-a-module-by-index) <br> `delete [INDEX] prof/[INDEX]`[(example)](#remove-a-professor-from-a-module-by-index) <br> `delete [INDEX] g/[GROUPNAME]`[(example)](#delete-a-group-from-a-module-by-index) <br> `delete [INDEX] ke/[INDEX]`[(example)](#delete-a-key-event-from-a-module-by-index) <br><br> **Groups View**: <br>`delete [INDEX]`[(example)](#delete-group-by-index) <br>`delete [INDEX] stu/[INDEX]`[(example)](#remove-student-from-group-by-index) <br> `delete [INDEX] mt/[INDEX]`[(example)](#delete-meeting-time-from-group-by-index) <br> 
