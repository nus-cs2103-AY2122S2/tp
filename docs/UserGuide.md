...
Examples:
- `status 1 s/blacklist` modules the 1st person in ModuleMate Finder as blacklisted.
- `status 2 s/favourite` modules the 2nd person in ModuleMate Finder as favourite.
...
| **Filter**        | `filter m/MODULE`                                                                                             | `filter m/CS3230`                      |
