...
* In the Excel sheet, the name of each column must follow in Figure 3.
...
| 2.  | `import`    | Add a list of students from an Excel file into Tracey                                     | `import C:\Users\Documents\Desktop\tp\students.xlsx`                                                                                                                                 |
