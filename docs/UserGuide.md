...
| COMMENT   | c/     | A comment can only contain **standard ASCII characters** and is limited to 300000 **ASCII characters**.                                                                                                                                                                                                                                                                                                                      |
...
| **Standard ASCII character**                   | [Standard ASCII character](https://www.techonthenet.com/ascii/chart.php) A 8-bit character set containing 128 characters. This includes number 0-9, upper and lower case english Letters (A-Z) and certain special characters.                |
