...
ContacX data are saved as a JSON file `[JAR file location]/data/contacx.json`. Advanced users are welcome to update data directly by editing that data file.

<div markdown="span" class="alert alert-warning">:exclamation: **Caution:**
If your changes to the data file makes its format invalid, ContacX will discard all data and start with an empty data file at the next run.
</div>
...
* Replacing `contacx.json` file with a valid ContacX formatted generated by another system with ContacX
