...
* **Enhancement**: Creation of the model component for `Task` as a baseline for the use by other teammates. [#64](https://github.com/AY2122S2-CS2103-F11-1/tp/pull/64)
...
* **Project management**:
  ...
  * Ensured the team's completion of weekly deliverables.
