...
public class LogicManagerTest {
    ...
    public void execute_commandExecutionError_throwsCommandException() {
        String deleteCommand = "delete ferrari";
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        ...
        String addCommand = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY
                + ADDRESS_DESC_AMY + SALARY_DESC_AMY + INFO_DESC_AMY + PREV_DATE_MET_DESC;
     ...
     */
    private static class JsonHustleBookIoExceptionThrowingStub extends JsonHustleBookStorage {
        private JsonHustleBookIoExceptionThrowingStub(Path filePath) {
            super(filePath);
        }
