...
public class LogicManagerTest {
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        ...
        // Execute add command
        String addCompanyCommand = AddCompanyCommand.COMMAND_WORD + " n/DBSSS " + "p/91123671 " + "e/dbsss@example.com "
                + "a/14 Jurong Street";
        Company expectedCompany = new CompanyBuilder(DBSSS).withTags().build();
