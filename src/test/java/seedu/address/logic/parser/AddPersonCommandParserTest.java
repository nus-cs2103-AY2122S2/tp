...
public class AddPersonCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + COMPANY_DESC_BOB + PHONE_DESC_BOB
                + EMAIL_DESC_BOB + TAG_DESC_FRIEND, new AddPersonCommand(expectedPerson));

        // multiple names - last name accepted
        assertParseSuccess(parser, NAME_DESC_AMY + NAME_DESC_BOB + COMPANY_DESC_BOB + PHONE_DESC_BOB
                + EMAIL_DESC_BOB + TAG_DESC_FRIEND, new AddPersonCommand(expectedPerson));

        // multiple phones - last phone accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_AMY + COMPANY_DESC_BOB + PHONE_DESC_BOB
                + EMAIL_DESC_BOB + TAG_DESC_FRIEND, new AddPersonCommand(expectedPerson));
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + VALID_PHONE_B + EMAIL_DESC_BOB + COMPANY_DESC_BOB,
                expectedMessage);

        // missing email prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + VALID_EMAIL_B + COMPANY_DESC_BOB,
                expectedMessage);

        // missing company name prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + VALID_COMPANY_JANICE_STREET,
                expectedMessage);
