...
public class ParserUtilTest {
    ...
    public void parseTags_collectionWithValidTags_returnsTagSet() throws Exception {
        Set<UserType> actualUserTypeSet = ParserUtil.parseTags(Arrays.asList(VALID_TAG_1, VALID_TAG_2));
        Set<UserType> expectedUserTypeSet = new HashSet<UserType>(Arrays.asList(new UserType(VALID_TAG_1), new UserType(VALID_TAG_2)));

        assertEquals(expectedUserTypeSet, actualUserTypeSet);
    }
}
