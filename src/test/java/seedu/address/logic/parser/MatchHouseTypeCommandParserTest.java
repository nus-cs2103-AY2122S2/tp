...
class MatchHouseTypeCommandParserTest {

    public final MatchHouseTypeCommandParser parser = new MatchHouseTypeCommandParser();

    @Test
    public void parse_validArgs_returnsMatchBuyerCommand() {
        assertParseSuccess(parser, "1", new MatchHouseTypeCommand(INDEX_FIRST_CLIENT));
        assertParseSuccess(parser, "2147483647", new MatchHouseTypeCommand(Index.fromOneBased(2147483647)));
    }
