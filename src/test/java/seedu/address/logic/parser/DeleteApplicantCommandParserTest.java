...
import seedu.address.logic.commands.delete.DeleteApplicantCommand;
...
public class DeleteApplicantCommandParserTest {
    ...
    public void parse_validArgs_returnsDeleteCommand() {
        assertParseSuccess(parser, FLAG_APPLICANT + "1", new DeleteApplicantCommand(INDEX_FIRST_PERSON));
    }
