...
public class EditCommandParserTest {
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withStudentId(VALID_ID_BOB)
                ...
                .withPhone(VALID_PHONE_AMY).withTelegramHandle(VALID_TELEGRAM_HANDLE_BOB).withEmail(VALID_EMAIL_AMY)
                .build();
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        descriptor = new EditPersonDescriptorBuilder().withPhone(VALID_NAME_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);

        // moduleCode
        userInput = targetIndex.getOneBased() + MODULE_CODE_DESC_AMY;
        descriptor = new EditPersonDescriptorBuilder().withPhone(VALID_MODULE_CODE_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
        ...
        descriptor = new EditPersonDescriptorBuilder().withEmail(VALID_TELEGRAM_HANDLE_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        ...
        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withStudentId(VALID_ID_BOB)
                .withName(VALID_NAME_AMY).withModuleCode(VALID_MODULE_CODE_BOB)
                .withPhone(VALID_PHONE_AMY).withTelegramHandle(VALID_TELEGRAM_HANDLE_BOB).withEmail(VALID_EMAIL_BOB)
                .build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
