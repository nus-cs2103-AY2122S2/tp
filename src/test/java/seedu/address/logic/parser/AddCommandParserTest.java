...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        //        .build();
        //assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
        //        + TAG_DESC_PF + TAG_DESC_SF, new AddCommand(expectedPersonMultipleTags));
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        //        + TAG_DESC_PF + TAG_DESC_SF, Name.MESSAGE_CONSTRAINTS);

        // invalid phone
        //assertParseFailure(parser, NAME_DESC_BOB + INVALID_PHONE_DESC + EMAIL_DESC_BOB
        //        + TAG_DESC_PF + TAG_DESC_SF, Phone.MESSAGE_CONSTRAINTS);

        // invalid email
        //assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + INVALID_EMAIL_DESC
        //        + TAG_DESC_PF + TAG_DESC_SF, Email.MESSAGE_CONSTRAINTS);

        // invalid address
        //assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
        //        + TAG_DESC_PF + TAG_DESC_SF, Address.MESSAGE_CONSTRAINTS);

        // invalid tag
        //assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
        //        + INVALID_TAG_DESC + VALID_TAG_SF, Tag.MESSAGE_CONSTRAINTS);
