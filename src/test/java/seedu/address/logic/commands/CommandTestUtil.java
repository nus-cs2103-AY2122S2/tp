...
public class CommandTestUtil {
    ...
    public static final String INVALID_NRIC_DESC = " " + PREFIX_NRIC + "S12345678"; // Not ending with a character
    ...
    public static void assertCommandFailure(Command command, Model actualModel, String expectedMessage) {
        ...
        MedBook expectedMedBook = new MedBook(actualModel.getMedBook());
        List<Patient> expectedFilteredList = new ArrayList<>(actualModel.getFilteredPatientList());

        assertThrows(CommandException.class, expectedMessage, () -> command.execute(actualModel));
        assertEquals(expectedMedBook, actualModel.getMedBook());
