...
public class CommandTestUtil {
    ...
    public static final String VALID_OWNERNAME_AMY = "Sarah Lee";
    public static final String VALID_OWNERNAME_BOB = "Bob Lee";
    ...
    public static final String OWNERNAME_DESC_AMY = " " + PREFIX_OWNERNAME + VALID_OWNERNAME_AMY;
    public static final String OWNERNAME_DESC_BOB = " " + PREFIX_OWNERNAME + VALID_OWNERNAME_BOB;
    ...
    public static final String INVALID_OWNERNAME_DESC = " " + PREFIX_OWNERNAME + "bob!yahoo"; // '!' not allowed in names
    ...
    static {
        DESC_AMY = new EditPetDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_AMY).withOwnerName(VALID_OWNERNAME_AMY).withAddress(VALID_ADDRESS_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditPetDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withOwnerName(VALID_OWNERNAME_BOB).withAddress(VALID_ADDRESS_BOB)
