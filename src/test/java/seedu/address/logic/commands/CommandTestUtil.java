...
public class CommandTestUtil {
    ...
    public static final String VALID_EDUCATION_AMY = "Computer Science";
    public static final String VALID_EDUCATION_BOB = "Computer Engineering";
    public static final String VALID_CCA_AMY = "Netball";
    public static final String VALID_CCA_BOB = "Basketball";
    public static final String VALID_INTERNSHIP_AMY = "GIC";
    public static final String VALID_INTERNSHIP_BOB = "Bosch";
    public static final String VALID_MODULE_AMY = "CS2040S";
    ...
    public static void showPersonAtIndex(Model model, Index targetIndex) {
        ...
        model.updateFilteredPersonList(new NameContainsKeywordsPredicateOr(Arrays.asList(splitName)));
    ...
    public static void showEventAtIndex(Model model, Index targetIndex) {
        ...
        final String splitName = event.getEventName().value;
        model.updateFilteredEventList(new EventNameContainsKeywordsPredicate(Arrays.asList(splitName)));
