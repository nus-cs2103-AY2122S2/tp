...
public class RedoCommandTest {
    ...
    @Test
    public void execute_redoCommand_addRedoSuccess() {
        try {
    ...
    @Test
    public void execute_redoCommand_deleteRedoSuccess() {
        try {
    ...
    @Test
    public void execute_redoCommand_editRedoSuccess() {
        try {
    ...
    @Test
    public void execute_redoCommand_addTagRedoSuccess() throws Exception {
        Person person = new PersonBuilder().build();
        AddressBookBuilder addressBookBuilder = new AddressBookBuilder().withPerson(person);
        Index index = Index.fromOneBased(1);
        Tag tag = VALID_TAG_HUSBAND.get(0);
        ...
        commandResult = new RedoCommand().execute(modelManager);

        assertEquals(String.format(RedoCommand.MESSAGE_SUCCESS), commandResult.getFeedbackToUser());
    }

    @Test
    public void execute_redoCommand_deleteTagRedoSuccess() throws Exception {
    ...
    @Test
    public void execute_redoCommand_editTagRedoSuccess() throws Exception {
