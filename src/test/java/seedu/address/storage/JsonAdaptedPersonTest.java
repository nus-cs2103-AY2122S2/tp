...
public class JsonAdaptedPersonTest {
    ...
    private static final String INVALID_LINEUPS = "111";
    ...
    private static final List<JsonAdaptedLineupName> VALID_LINEUPS = BENSON.getLineups().stream()
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_HEIGHT, VALID_JERSEY_NUMBER, VALID_TAGS, VALID_LINEUPS, VALID_WEIGHT);
    ...
    public void toModelType_invalidHeight_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                        INVALID_HEIGHT, VALID_JERSEY_NUMBER, VALID_TAGS, VALID_LINEUPS, VALID_WEIGHT);
    ...
    public void toModelType_nullHeight_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                null, VALID_JERSEY_NUMBER, VALID_TAGS, VALID_LINEUPS, VALID_WEIGHT);
    ...
    public void toModelType_invalidJerseyNumber_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_HEIGHT, INVALID_JERSEY_NUMBER, VALID_TAGS, VALID_LINEUPS, VALID_WEIGHT);
    ...
    public void toModelType_nullJerseyNumber_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_HEIGHT, null, VALID_TAGS, VALID_LINEUPS, VALID_WEIGHT);
    ...
    public void toModelType_invalidWeight_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_HEIGHT, VALID_JERSEY_NUMBER, VALID_TAGS, VALID_LINEUPS,INVALID_WEIGHT);
    ...
    public void toModelType_nullWeight_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_HEIGHT, VALID_JERSEY_NUMBER, VALID_TAGS, VALID_LINEUPS,null);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_HEIGHT, VALID_JERSEY_NUMBER, invalidTags, VALID_LINEUPS,VALID_WEIGHT);
