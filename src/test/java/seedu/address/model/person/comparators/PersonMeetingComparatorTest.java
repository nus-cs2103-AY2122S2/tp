...
class PersonMeetingComparatorTest {
    ...
    private PersonMeetingComparator comparator = new PersonMeetingComparator();

    @Test
    public void compare_earlier_later() {
        assertEquals(comparator.compare(ALICE, PETER), -1);
    }

    @Test
    public void compare_later_earlier() {
        assertEquals(comparator.compare(PETER, ALICE), 1);
    }

    @Test
    public void compare_sameMeeting() {
