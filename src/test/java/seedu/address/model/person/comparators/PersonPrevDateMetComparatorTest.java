...
class PersonPrevDateMetComparatorTest {
    ...
    private PersonPrevDateMetComparator comparator = new PersonPrevDateMetComparator();

    @Test
    public void compare_older_recent() {
        assertEquals(comparator.compare(ALICE, PETER), -1);
    }

    @Test
    public void compare_recent_older() {
        assertEquals(comparator.compare(PETER, ALICE), 1);
    }

    @Test
    public void compare_samePrev() {
