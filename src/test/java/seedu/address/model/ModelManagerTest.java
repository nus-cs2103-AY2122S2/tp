...
import seedu.address.testutil.UniBookBuilder;
...
public class ModelManagerTest {
    ...
    public void setUniBookFilePath_nullPath_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () -> modelManager.setUniBookFilePath(null));
    }
    ...
    @Test
    public void equals() {
        UniBook uniBook = new UniBookBuilder().withPerson(ALICE).withPerson(BENSON).build();
