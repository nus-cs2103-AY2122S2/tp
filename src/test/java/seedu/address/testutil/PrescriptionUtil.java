...
public class PrescriptionUtil {
    ...
    public static String getEditPrescriptionDescriptorDetails(EditPrescriptionDescriptor descriptor) {
        ...
        descriptor.getPrescriptionDate().ifPresent(date -> sb.append(PREFIX_DATE).append(date.toDefaultString()).append(" "));
        descriptor.getInstruction().ifPresent(instruction -> sb.append(PREFIX_INSTRUCTION).append(instruction.value).append(" "));
        return sb.toString();
    }
}
