...
public class TypicalPersons {
    ...
    public static final Person BENSON = new PersonBuilder().withName("Benson Meier")
            ...
            .withJerseyNumber("0").withTags("owesMoney", "friends").build();
    ...
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            .withEmail(VALID_EMAIL_AMY).withTags(VALID_TAG_FRIEND).withHeight(VALID_HEIGHT_AMY)
            .withJerseyNumber(VALID_JERSEY_NUMBER_AMY).withWeight(VALID_WEIGHT_AMY).build();
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            .withEmail(VALID_EMAIL_BOB).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).withHeight(VALID_HEIGHT_BOB)
