...
public class CommandTestUtil {
    ...
    public static final String HAIR_TYPE_DESC_AMY = " " + PREFIX_SKINTYPE + VALID_HAIR_TYPE_AMY;
    public static final String HAIR_TYPE_DESC_BOB = " " + PREFIX_SKINTYPE + VALID_HAIR_TYPE_BOB;
    ...
    public static final String INVALID_STAFFS_DESC = " " + PREFIX_STAFFS + "Jane*"; //* not allowed for tags
    public static final String INVALID_SERVICE_DESC = " " + PREFIX_SERVICES
            + "Chemical Peels*"; //* not allowed for tags
    public static final String INVALID_ALLERGY_DESC = " " + PREFIX_ALLERGIES
            + "Nickel*"; //* not allowed for tags
