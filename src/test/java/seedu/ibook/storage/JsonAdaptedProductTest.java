...
public class JsonAdaptedProductTest {
    ...
    private static final String INVALID_DISCOUNTRATE = "101";
    private static final String INVALID_DISCOUNTSTART = "-4";
    ...
    private static final String VALID_DISCOUNTRATE = KAYA_BREAD.getDiscountRate().toString();
    private static final String VALID_DISCOUNTSTART = KAYA_BREAD.getDiscountStart().toString();
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedProduct product =
                new JsonAdaptedProduct(INVALID_NAME, VALID_CATEGORY, VALID_DESCRIPTION,
                        VALID_PRICE, VALID_DISCOUNTRATE, VALID_DISCOUNTSTART, null);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedProduct product =
                new JsonAdaptedProduct(null, VALID_CATEGORY, VALID_DESCRIPTION, VALID_PRICE,
                        VALID_DISCOUNTRATE, VALID_DISCOUNTSTART, null);
    ...
    public void toModelType_invalidDiscountRate_throwsIllegalValueException() {
        JsonAdaptedProduct product =
                new JsonAdaptedProduct(VALID_NAME, VALID_CATEGORY, VALID_DESCRIPTION, VALID_PRICE,
                        INVALID_DISCOUNTRATE, VALID_DISCOUNTSTART, null);
    ...
    public void toModelType_invalidDiscountStart_throwsIllegalValueException() {
        JsonAdaptedProduct product =
                new JsonAdaptedProduct(VALID_NAME, VALID_CATEGORY, VALID_DESCRIPTION, VALID_PRICE,
                        VALID_DISCOUNTRATE, INVALID_DISCOUNTSTART, null);
