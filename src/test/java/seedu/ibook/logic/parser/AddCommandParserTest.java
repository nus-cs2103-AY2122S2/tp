...
public class AddCommandParserTest {
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing name prefix
        assertParseFailure(parser, VALID_NAME_B + CATEGORY_FULL_B + EXPIRY_DATE_FULL_B + DESCRIPTION_FULL_B,
            expectedMessage);

        // missing phone prefix
        assertParseFailure(parser, NAME_FULL_B + VALID_CATEGORY_B + EXPIRY_DATE_FULL_B + DESCRIPTION_FULL_B,
            expectedMessage);

        // missing email prefix
        assertParseFailure(parser, NAME_FULL_B + CATEGORY_FULL_B + VALID_EXPIRY_DATE_B + DESCRIPTION_FULL_B,
            expectedMessage);

        // missing address prefix
        assertParseFailure(parser, NAME_FULL_B + CATEGORY_FULL_B + EXPIRY_DATE_FULL_B + VALID_DESCRIPTION_B,
            expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_NAME_B + VALID_CATEGORY_B + VALID_EXPIRY_DATE_B + VALID_DESCRIPTION_B,
            expectedMessage);
    }
