...
public class ParserUtilTest {
    ...
    public void parseIndex_validInput_success() throws Exception {
        // No whitespaces
        Assertions.assertEquals(TypicalIndexes.INDEX_FIRST_PET, ParserUtil.parseIndex("1"));
    ...
    public void parseOwnerName_null_throwsNullPointerException() {
        Assert.assertThrows(NullPointerException.class, () -> ParserUtil.parseOwnerName((String) null));
    }

    @Test
    public void parseOwnerName_invalidValue_throwsParseException() {
        Assert.assertThrows(ParseException.class, () -> ParserUtil.parseOwnerName(INVALID_OWNERNAME));
    }
    ...
    public void parseOwnerName_validValueWithoutWhitespace_returnsOwnerName() throws Exception {
        ...
        Assertions.assertEquals(expectedOwnerName, ParserUtil.parseOwnerName(VALID_OWNERNAME));
    }
    ...
    public void parseOwnerName_validValueWithWhitespace_returnsTrimmedOwnerName() throws Exception {
        ...
        OwnerName expectedOwnerName = new OwnerName(VALID_OWNERNAME);
        Assertions.assertEquals(expectedOwnerName, ParserUtil.parseOwnerName(ownerNameWithWhitespace));
    }
    ...
    public void parseAttendanceDate_returnsLocalDate() throws Exception {
        ...
        Assert.assertThrows(ParseException.class, () -> ParserUtil.parseAttendanceDate("2022-03-22"));
    }
    ...
    public void parseAppointmentDateTime_returnsLocalDateTime() throws Exception {
        ...
        Assert.assertThrows(ParseException.class, () -> ParserUtil.parseAppointmentDateTime("2022-03-22 0830"));
    }
    ...
    public void parseFilterDate_returnsLocalDate() throws Exception {
        ...
        Assert.assertThrows(ParseException.class, () -> ParserUtil.parseFilterDate("2022-03-22"));
    }
    ...
    public void parseFilterAppDate_returnsLocalDate() throws Exception {
        ...
        Assert.assertThrows(ParseException.class, () -> ParserUtil.parseFilterAppointmentDate("2022-03-22"));
    }
    ...
    public void parsePickUpTime_returnsLocalTime() throws Exception {
        ...
        Assert.assertThrows(ParseException.class, () -> ParserUtil.parsePickUpTime("0800"));
    }
    ...
    public void parseDropOffTime_returnsLocalTime() throws Exception {
        ...
        Assert.assertThrows(ParseException.class, () -> ParserUtil.parseDropOffTime("0800"));
    }
}
