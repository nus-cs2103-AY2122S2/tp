...
public class EditPetDescriptorTest {
    ...
    public void equals() {
        ...
        EditCommand.EditPetDescriptor descriptorWithSameValues =
                new EditCommand.EditPetDescriptor(CommandTestUtil.DESC_AMY);
        ...
        EditCommand.EditPetDescriptor editedAmy = new EditPetDescriptorBuilder(CommandTestUtil.DESC_AMY)
                .withName(CommandTestUtil.VALID_NAME_BOB).build();
        Assertions.assertFalse(CommandTestUtil.DESC_AMY.equals(editedAmy));

        // different phone -> returns false
        editedAmy = new EditPetDescriptorBuilder(CommandTestUtil.DESC_AMY)
                .withPhone(CommandTestUtil.VALID_PHONE_BOB).build();
        Assertions.assertFalse(CommandTestUtil.DESC_AMY.equals(editedAmy));

        // different email -> returns false
        editedAmy = new EditPetDescriptorBuilder(CommandTestUtil.DESC_AMY)
                .withOwnerName(CommandTestUtil.VALID_OWNER_NAME_BOB).build();
        Assertions.assertFalse(CommandTestUtil.DESC_AMY.equals(editedAmy));
