...
import static manageezpz.logic.commands.CommandTestUtil.VALID_TODO_DESC_DRINK;
...
public class AddTodoTaskCommandParserTest {
    ...
    // THIS WILL ALWAYS GIVE ME A DIFFERENT OBJECT!!
    //    @Test
    ...
    //        assertParseSuccess(parser,PREAMBLE_WHITESPACE + VALID_TODO_DESC_DRINK,
    ...
    //                new AddTodoTaskCommand(expectedPerson));
    //  }
    ...
    public void parse_invalidValue_failure() {
        ...
        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + VALID_TODO_DESC_DRINK,
