...
public class EditCompanyCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD
            + "\n"
            + "Function: Edits the details of the company identified by the index number used in the displayed "
            + "company list. Existing values will be overwritten by the input values."
            + "\n"
            + "Format: " + COMMAND_WORD + " "
