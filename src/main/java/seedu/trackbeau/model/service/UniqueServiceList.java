...
import seedu.trackbeau.model.service.exceptions.DuplicateServiceException;
import seedu.trackbeau.model.service.exceptions.ServiceNotFoundException;
 ...
 * updating of services uses Service#isSameService(Service) for equality so as to ensure that the service being
 * added or updated is unique in terms of identity in the UniqueServiceList. However, the removal of a service uses
...
public class UniqueServiceList implements Iterable<Service> {
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
                || (other instanceof UniqueServiceList // instanceof handles nulls
                && internalList.equals(((UniqueServiceList) other).internalList));
    }
