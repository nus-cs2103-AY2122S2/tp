...
/**
 * Edits the details of an existing person in the trackbeau book.
 */
public class EditCommand extends Command {
    ...
    public static final String MESSAGE_DUPLICATE_PERSON = "This person already exists in the trackbeau book.";
