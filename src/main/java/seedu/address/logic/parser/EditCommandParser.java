...
public class EditCommandParser implements Parser<EditCommand> {
    ...
    public EditCommand parse(String args) throws ParseException {
        ...
        if (argMultimap.getValue(PREFIX_BLOCK).isPresent()) {
            editPersonDescriptor.setBlock(ParserUtil.parseBlock(argMultimap.getValue(PREFIX_BLOCK).get()));
        }
        ...
        if (argMultimap.getValue(PREFIX_COVID_STATUS).isPresent()) {
            editPersonDescriptor.setCovidStatus(ParserUtil
                    .parseCovidStatus(argMultimap.getValue(PREFIX_COVID_STATUS).get()));
        }
