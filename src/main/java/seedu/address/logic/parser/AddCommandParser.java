...
public class AddCommandParser implements Parser<AddCommand> {
    ...
    public AddCommand parse(String args) throws ParseException {
        ...
        // Refactor Tag to be a single tag
        UserType userType = ParserUtil.parseTag(argMultimap.getValue(PREFIX_TAG).get());
        // Storing Tag in a Set, to comply with current implementation of Person accepting a Set<Tag>
