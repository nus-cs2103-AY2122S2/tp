...
public class HelpArgument {
    ...
    public static final String EDIT_COMMAND_DESCRIPTION =
            ...
            + "Format: 'edit -a APPLICANT_INDEX [n/APPLICANT_NAME] [ag/AGE] [g/GENDER]"
            ...
            + "- Number of openings in the position cannot be edited to be lower than the current number "
    ...
    public static final String DELETE_COMMAND_DESCRIPTION =
            ...
            + "- However, Applicants that have already accepted a job at said Position,"
            + " will retain their status as being hired for that Position. \n"
            + "- The index refers to the index number shown in the displayed Interview list \n"
            + "Examples: \n"
            + "delete -p 3";

    public static final String LIST_COMMAND_DESCRIPTION =
            "General command to list all different data type in HireLah "
            ...
            + "View applicants with a tag that matches the keywords(s) \n"
            ...
            + " View interviews for positions with names that contains the keyword(s) \n"
            + " + FILTER_TYPE: date, FILTER_ARGUMENT: Date the interview is happening in 'yyyy-mm-dd':"
            + " View interviews which happens on the date provided \n"
