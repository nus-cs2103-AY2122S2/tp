...
import seedu.address.storage.HustleBookStorage;
import seedu.address.storage.JsonHustleBookStorage;
...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        logger.info("=============================[ Initializing HustleBook ]===========================");
        super.init();
    ...
    /**
     * Returns a {@code ModelManager} with the data from {@code storage}'s hustle book and {@code userPrefs}. <br>
     * The data from the sample hustle book will be used instead if {@code storage}'s hustle book is not found,
     * or an empty hustle book will be used instead if errors occur when reading {@code storage}'s hustle book.
     */
    private Model initModelManager(Storage storage, ReadOnlyUserPrefs userPrefs) {
        ...
        try {
            ...
            logger.warning("Problem while reading from the file. Will be starting with an empty HustleBook");
            initialData = new HustleBook();
        }
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting HustleBook " + MainApp.VERSION);
        ui.start(primaryStage);
    }

    @Override
    public void stop() {
        logger.info("============================ [ Stopping Hustle Book ] =============================");
        try {
