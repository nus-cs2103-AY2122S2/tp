...
class JsonAdaptedPerson {
    ...
    public JsonAdaptedPerson(@JsonProperty("name") String name, @JsonProperty("phone") String phone,
            @JsonProperty("email") String email, @JsonProperty("academic major") String academicMajor,
    ...
    public JsonAdaptedPerson(Person source) {
        ...
        academicMajor = source.getAcademicMajor().value;
    ...
    public Person toModelType() throws IllegalValueException {
        ...
        final AcademicMajor modelAcademicMajor = new AcademicMajor(academicMajor);

        final Set<Tag> modelTags = new HashSet<>(personTags);
        return new Person(modelName, modelPhone, modelEmail, modelAcademicMajor, modelTags);
    }
