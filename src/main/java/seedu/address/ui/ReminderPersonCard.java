...
public class ReminderPersonCard extends UiPart<Region> {
    ...
    private static final String FXML = "ReminderPersonListCard.fxml";
     ...
     */
    public ReminderPersonCard(Person person, int displayedIndex) {
        super(FXML);
        this.person = person;
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ReminderPersonCard)) {
            return false;
        }

        // state check
        ReminderPersonCard card = (ReminderPersonCard) other;
