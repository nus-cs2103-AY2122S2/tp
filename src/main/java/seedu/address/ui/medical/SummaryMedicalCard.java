...
public class SummaryMedicalCard extends UiPart<Region> {

    private static final String FXML = "medical/SummaryMedicalCard.fxml";
     ...
     */
    public SummaryMedicalCard(Medical medical) {
        super(FXML);
        this.medical = null;
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof SummaryMedicalCard)) {
            return false;
        }

        // state check
        SummaryMedicalCard card = (SummaryMedicalCard) other;
