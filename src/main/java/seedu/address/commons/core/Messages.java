...
public class Messages {
    ...
    public static final String MESSAGE_NO_CANDIDATES_DISPLAYED = "There are no candidates in the system!";
    ...
    public static final String MESSAGE_NO_INTERVIEWS_DISPLAYED = "There are no interviews displayed!";
}
