...
/**
 * Container for user visible messages regarding the manual command.s
 */
...
public class ManualMessages {
    ...
    public static final String MANUAL_MESSAGE_FIND_COMMAND = "Allows the user to look up the details of a particular student. \n" +
    ...
    public static final String MANUAL_MESSAGE_MANUAL_COMMAND = "Display the format for a specified command and a short description for a particular command. \n" +
            "Format : manual [COMMAND_NAME] \n" +
            "Example: manual add \n" +
            "Kind of weird that you have to use 'manual'... to find out what 'manual' does... :( Trying to find a bug?";

    public static final String MANUAL_MESSAGE_HELP_COMMAND = "Shows a pop-up window explaining how to access the user guide. \n" +
            "Format : help \n" +
            "Example: help";
    ...
    public static final String MANUAL_MESSAGE_TASK_COMMAND = "Displays all the tasks that are allocated to a particular student. \n"+
        "Format: task i/STUDENT_ID \n" +
        "Example: task i/A6942069R";

    public static final String MANUAL_MESSAGE_MARK_COMMAND = "Marks a specific undone task as done for a particular student. \n" +
            "Format : mark i/STUDENT_ID UNDONE_TASK_INDEX \n" +
            "Example: mark i/A6942069R 1";

    public static final String MANUAL_MESSAGE_UNMARK_COMMAND = "Marks a specific done task as undone for a particular student. \n" +
            "Format : unmark i/STUDENT_ID DONE_TASK_INDEX \n" +
            "Example: unmark i/A6942069R 1";

    public static final String MANUAL_MESSAGE_ARCHIVE_COMMAND = "Saves a copy of the details currently saved in the address book into a separate file. \n" +
            "Format : archive \n" +
            "Example: archive";
