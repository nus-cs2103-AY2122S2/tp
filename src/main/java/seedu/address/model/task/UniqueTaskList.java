...
public class UniqueTaskList implements Iterable<Task> {
     ...
     */
    public boolean contains(Task taskToCheck) {
        requireNonNull(taskToCheck);
        return internalList.stream().anyMatch(taskToCheck::isSameTask);
    }
    ...
    public void setTasks(seedu.address.model.task.UniqueTaskList replacement) {
