...
public class BloodType {
    ...
    public static final String MESSAGE_CONSTRAINTS = "We recommend using ABO blood system, but allow any blood system or special blood type values. Blood type can take any values, and it should not be blank.";
