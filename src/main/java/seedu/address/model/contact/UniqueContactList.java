 ...
 * As such, adding and updating of contacts uses Contact#isSameContact(Contact)
 * for equality to ensure that the contact being added or updated is
...
public class UniqueContactList implements Iterable<Contact> {
     ...
     */
    public void add(Contact toAdd) throws DuplicateContactException {
