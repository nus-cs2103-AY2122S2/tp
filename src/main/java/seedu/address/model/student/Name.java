...
public class Name {
    ...
    public static final String MESSAGE_CONSTRAINTS =
            "Names should only contain alphanumeric characters, spaces and are limited to 50 characters." +
                    "Names should not contain only numbers and should not be blank";
