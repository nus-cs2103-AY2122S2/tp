 ...
 */
public class CourseContainsKeywordsPredicate extends ContainsKeywordsPredicate implements Predicate<Person> {
     ...
     * @param keywords contain keyword(s) to find in {@code Person}'s {@code Course}.
     */
    ...
    /**
     * Tests if any part of {@code Person}'s {@code Course} matches any of the specified
     * {@link CourseContainsKeywordsPredicate#keywords}.
     * @param person object to retrieve the {@code Course}.
     * @return true if a match is found, and false otherwise.
     */
    @Override
    public boolean test(Person person) {
        return keywords.stream()
                .anyMatch(keyword -> StringUtil.containsStringIgnoreCase(person.getCourse().toString(), keyword));
    }
