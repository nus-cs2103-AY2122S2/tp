 ...
 *     e.g. {@code some preamble text n/ amongus s/completed r/4}  where prefixes are {@code n/ s/ r/}.<br>
 * 1. An argument's value can be an empty string e.g. the value of {@code r/} in the above example.<br>
